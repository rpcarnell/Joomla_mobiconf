...
class GrabzItClient
{
	...
	*/
	public function SavePicture($url, $saveToFile, $browserWidth = null, $browserHeight = null, $width = null, $height = null, $format = null, $delay = null, $targetElement = null, $requestAs = 0)
	{
		//SetImageOptions($url, null, null, null, null, null, null, null, 1)
             $this->SetImageOptions($url, '', $browserWidth, $browserHeight, $width, $height, $format, $delay, $targetElement, $requestAs, null, 50);
